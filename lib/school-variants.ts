  ...
  "seda-debate": [
    {
      ...
      university: "성신여대",
      steps: [
        { id: "step-1", type: "기조발언", time: 90, team: "긍정" }, // 기조발언
        { id: "step-2", type: "기조발언", time: 90, team: "부정" }, // 기조발언
        { id: "step-3", type: "교차질의", time: 120, team: "긍정" },
        { id: "step-4", type: "교차질의", time: 120, team: "부정" },
        ...
        { id: "step-8", type: "마무리 발언", time: 90, team: "부정" },
        { id: "step-9", type: "마무리 발언", time: 90, team: "긍정" },
      ],
    }
  ],
}; 